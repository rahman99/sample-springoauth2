...
values ('p001', 'ROLE_USER_EDIT', 'Add / Remove User');

insert into s_permission (id, name, description)
values ('p002', 'ROLE_USER_VIEW', 'View User');

insert into s_role (id, name, description)
values ('r001', 'ROLE_Admin', 'Administrator');

insert into s_role (id, name, description)
values ('r002', 'ROLE_Staff', 'Staff');
...
insert into dummy values('111', 'test 111'),
('112', 'test 122'),
('113', 'test 123'),
('114', 'test 124');